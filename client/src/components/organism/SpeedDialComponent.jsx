...
import { BsFillPersonCheckFill, BsQrCodeScan } from "react-icons/bs";
  ...
  return (
    <div data-dial-init className="fixed end-8 bottom-12 z-[300]">
      <div
        ...
        className={`flex flex-col items-center mb-4 space-y-2 overflow-y-hidden  ${
          !dialState ? `opacity-100 ${dialHeight}` : "h-0 opacity-0"
