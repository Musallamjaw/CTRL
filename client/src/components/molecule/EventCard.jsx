...
function EventCard({
  ...
  return (
    <div
      ...
      } p-1 border bg-slate-200 rounded-xl gap-4 2md:max-h-72 relative`}
    >
      <img
        src={`https://sweet-spot-server.onrender.com/uploads/eventsImage/${image}`}
        alt={title}
      ...
      <div className="text-black mt-4 w-full flex flex-col justify-between text-center 2xmobile:text-start overflow-y-auto">
        <div>
          ...
          <p className="mb-2 text-sm 2xmobile:text-base font-semibold tracking-tight">
            Price: <span className="text-gray-600">KWD </span>
            {price}
          </p>
        </div>
